...
export default function PhotGrid() {
  return (
    <StyledPhotoGrid>
      <div className="card">
        <img src="images/headshots/headshot1.webp" alt="Portrait photo 1" />
        <div className="card__content">
          <h2 className="card__title">man</h2>
          <p className="card__description">blah blah</p>
        </div>
      </div>
      <div className="card">
        <img src="images/headshots/headshot2.webp" alt="Portrait photo 2" />
        <div className="card__content">
          <h2 className="card__title">man</h2>
          <p className="card__description">blah blah</p>
        </div>
